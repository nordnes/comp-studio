...
<template>
  <div class="no-print flex items-center gap-x-4 gap-y-1 flex-wrap text-xs px-4 py-2 rounded border border-outline-gray-1 bg-surface-gray-1 text-ink-gray-5">
    <span class="text-ink-amber-3">Base path</span>
