  ...
  <div class="bg-surface-white rounded border border-outline-gray-1 p-5">
    ...
    <div class="grid lg:grid-cols-2 gap-4">
      <div>
        ...
        <FrappeChart type="line" :data="eqChart" :height="190" :colors="['#9C4A0C']" :options="areaOpts" :aria-label="`Equity net value vs exit company value, net of strike. Underwater below ${fUSD(breakeven)} exit; ${(sb.retention * 100).toFixed(0)}% retained after dilution.`" />
      ...
      <div>
        ...
        <FrappeChart type="line" :data="tkChart" :height="190" :colors="['#C46A1F']" :options="lineOpts" aria-label="Token value vs TGE fully-diluted valuation, rising linearly from zero." />
